...
fn main() -> std::io::Result<()> {
    ...
    let extent = geom::Bounds2 {
        min: geom::Vec2 { x: -air::WOOFTRIM_OUTER_RADIUS, y: -air::WOOFTRIM_OUTER_RADIUS },
        max: geom::Vec2 {
    ...
    println!(
        ...
        utils::gen_rounded_rect(
          &mut dxf_writer,
          &utils::RoundedRect{
            ll: geom::Vec2{x: -air::FRGASKET_WIDTH/2.0, y:-air::FRGASKET_HEIGHT/2.0},
            ur: geom::Vec2{x: air::FRGASKET_WIDTH/2.0, y:air::FRGASKET_HEIGHT/2.0},
            round_radius: 20.0
        })
    );
    ...
    println!(
        ...
        dxf_writer.gen_circle(geom::Circle {
            center: geom::Vec2{x: 0.0, y: topfr_center_y},
            radius: air::FRGASKET_CUTOUT_RADIUS,
        })
    );
    println!(
        "{}",
    ...
    println!(
        "{}",
        dxf_writer.gen_circle(geom::Circle {
            center: geom::Vec2{x: 0.0, y: bottomfr_center_y},
            radius: air::FRGASKET_CUTOUT_RADIUS,
        })
    );
    println!(
