...
pub const STAND_BAR_THICKNESS: f64 = (BAFFLE_LL_STAND_HOLE_CENTER_X + BAFFLE_STAND_HOLE_LENGTH/2.0 + BAFFLE_STAND_HOLE_THICKNESS/2.0) - (BAFFLE_UL_STAND_HOLE_CENTER_X - BAFFLE_STAND_HOLE_LENGTH/2.0 - BAFFLE_STAND_HOLE_THICKNESS/2.0) + 8.0;
